...
test("packed installs include typebox without peer dependencies", async () => {
	...
	try {
		...
		const packageRequire = createRequire(join(tempDir, "node_modules", "@moguw", "pi-web-access", "package.json"));
		const installedManifest = packageRequire("@moguw/pi-web-access/package.json");
